...
/**
 * create_file - Creates a new file with the specified filename and writes content to it.
 * @filename: The name of the file to be created
 * @text_content: The text content to be written to the file
 * Return: On success, returns 1. On failure or if the file already exists, returns -1.
 */
...
/**
 * perform_operation - Performs a specific mathematical operation on two numbers.
